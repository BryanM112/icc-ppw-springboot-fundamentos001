package ec.edu.ups.icc.fundamentos001.users.dtos;
...
public class UpdateUserDto {
    ...
    public UpdateUserDto(
            ...
            //@NotBlank(message = "La contraseña debe ser obligatoria") @Size(min = 8, message = "La contraseña debe tener al menos 8 caracteres") String password
            ) {
        this.name = name;
        this.email = email;
